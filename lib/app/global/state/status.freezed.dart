...
class __$$InitialImplCopyWithImpl<T, $Res>
    extends _$StatusCopyWithImpl<T, $Res, _$InitialImpl<T>>
...
abstract class Initial<T> implements Status<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$StatusCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class __$$LoadedImplCopyWithImpl<T, $Res>
    extends _$StatusCopyWithImpl<T, $Res, _$LoadedImpl<T>>
...
class _$LoadedImpl<T> implements Loaded<T> {
  ...
  @override
  String toString() {
    return 'Status<$T>.loaded(data: $data)';
  }
...
abstract class Loaded<T> implements Status<T> {
  const factory Loaded({required final T data}) = _$LoadedImpl<T>;
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$StatusCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'Status<$T>.error(message: $message)';
  }
...
abstract class Error<T> implements Status<T> {
